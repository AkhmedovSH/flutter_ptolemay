    ...
    Widget body(int index) {
      return ValueListenableBuilder<bool>(
        ...
        builder: (BuildContext context, bool isDark, Widget? child) {
          return Theme(data: index == 2 ? getTheme(!isDarkVisible) : getTheme(isDarkVisible), child: widget.childBuilder(context, index));
        },
      );
    }
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        return Stack(
          children: [
            body(1),
            ClipPath(clipper: CircularClipper(_animationController.value * radius, position), child: body(2)),
          ],
        );
      },
    );
